...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Mise a jour de ${vehicle.constructeur} ${vehicle.model}
            </h1>
        </section>
                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="modele" name="modele" placeholder="Modele" required value="${vehicle.model}">
                                    </div>
                                </div>
                                <div class="form-group">
